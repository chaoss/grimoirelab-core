...
from .serializers import (
    ...
    JobSerializer,
    JobLogsSerializer,
    AffiliateTaskSerializer,
    GenderizeTaskSerializer,
    UnifyTaskSerializer,
    ImportIdentitiesTaskSerializer,
    RecommendAffiliationsTaskSerializer,
    RecommendGenderTaskSerializer,
    RecommendMatchesTaskSerializer,
)
...
TASKS_SERIALIZERS = {
    ...
    AffiliateTask.TASK_TYPE: AffiliateTaskSerializer,
    GenderizeTask.TASK_TYPE: GenderizeTaskSerializer,
    UnifyTask.TASK_TYPE: UnifyTaskSerializer,
    ImportIdentitiesTask.TASK_TYPE: ImportIdentitiesTaskSerializer,
    RecommendAffiliationsTask.TASK_TYPE: RecommendAffiliationsTaskSerializer,
    RecommendGenderTask.TASK_TYPE: RecommendGenderTaskSerializer,
    RecommendMatchesTask.TASK_TYPE: RecommendMatchesTaskSerializer,
}
...
class ListCreateTasks(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        task = schedule_task(task_type, **serializer.create_scheduler_task_args())
